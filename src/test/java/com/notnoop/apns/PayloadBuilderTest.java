...
public class PayloadBuilderTest {
	...
	public void localizedTitleKeyAndArguments() {
		final PayloadBuilder builder = new PayloadBuilder().localizedTitleKey(
				"GAME_PLAY_REQUEST_FORMAT").localizedTitleArguments("Jenna",
				"Frank");
		builder.sound("chime");
	...
	public void removeAlertIfSooLong() {
		final PayloadBuilder tooLong = APNS.newPayload()
				.customField("test", strOfLen(2048)).alertBody("what");
		tooLong.shrinkBody();
